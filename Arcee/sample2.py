...
def main(mode, args):
    ...
    if use_cfg:
        torchvision.utils.save_image(samples, f"{inference_path}/{class_labels[0]}_sample_cfg{args.cfg_scale}.png", nrow=8, normalize=True, value_range=(-1, 1), pad_value=1.)
    else:
        torchvision.utils.save_image(samples, f"{inference_path}/sample.png", nrow=8, normalize=True, value_range=(-1, 1), pad_value=1.)
