...
torchrun --standalone --nproc_per_node=$NUM_GPUS ../Arcee/fid50k.py --exp ../L40runs/results/${EXP}  --datadir ../data/celeba256/ --dataset celeba_256 --eval-refdir ../data/celeba256/real_samples \
  --model-type ema \
